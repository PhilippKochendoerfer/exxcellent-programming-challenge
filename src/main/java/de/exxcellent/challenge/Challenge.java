...
public class Challenge {
     ...
     * @param format The format of the data file (--csv or --json).
     ...
     */
    public static String challenge(String app, String format, String file) throws IOException, InvalidDataException {

        try (DataReader dataReader = DataReaderFactory.create(format, file)) {
